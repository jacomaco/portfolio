...
const Education = () => {
  return (
    <section id="education" className="section bg-hero">
      <FadeInSection>
        <div className="container">
          <h2 className="section-title title-light">Utbildning</h2>
          <div className="education-grid">
            {education.map((edu, index) => (
              <div key={index} className="education-card card-glass hover-lift">
                ...
                <div className="education-content">
                  ...
                  <span className="education-period badge-glass">{edu.period}</span>
